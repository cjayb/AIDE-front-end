...
describe("Get Pipeline for correlation", () => {
    ...
    describe("Get Pipeline for correlation", () => {
        ...
        it("Will return a list of all models", async () => {
            const response = await pipelineClient.fetchPipeline("4e67b9e0-07b7-41e8-93c7-6f1561686ebc")
    ...
    describe("Get pipeline, no auth", () => {
        ...
        it("Will return a 401", () => {
            const response = pipelineClient.fetchPipelineNoAuth("4e67b9e0-07b7-41e8-93c7-6f1561686ebc")
